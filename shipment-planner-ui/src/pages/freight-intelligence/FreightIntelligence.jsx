...
export default function FreightIntelligence() {
  ...
  const MASTER_VEHICLES = [
    { id: 'US-IL-4412', class: '40ft Container', driver: 'R. Miller', baseUtil: 91, nextService: 'in 1,200 km', status: 'Active', pill: 'g', region: 'US Midwest', carrier: 'In-house Fleet' },
    { id: 'US-NY-8830', class: 'Reefer', driver: 'S. Davis', baseUtil: 58, nextService: 'overdue 400 km', status: 'Service Due', pill: 'r', region: 'US East', carrier: '3PL Partners' },
    { id: 'US-GA-1177', class: 'Last-Mile Van', driver: 'A. Johnson', baseUtil: 44, nextService: 'in 3,500 km', status: 'Idle 2d', pill: 'a', region: 'US South', carrier: 'In-house Fleet' },
    { id: 'US-CA-6621', class: '32ft Multi-Axle', driver: 'P. Smith', baseUtil: 87, nextService: 'in 800 km', status: 'Active', pill: 'g', region: 'US West', carrier: '3PL Partners' },
    { id: 'US-TX-2044', class: '20ft Box', driver: 'M. Wilson', baseUtil: 33, nextService: 'in 2,100 km', status: 'Breakdown', pill: 'r', region: 'US South', carrier: 'In-house Fleet' }
  ];
